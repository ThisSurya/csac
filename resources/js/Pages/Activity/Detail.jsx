        ...
        <div className="">
            ...
            <div className="m-10">
                ...
                <div className="pb-2 border-b-2 border-gray-300 flex pt-10">
                    ...
                    <div className="mt-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#d1d5db" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
                    ...
                    <div className="mt-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#d1d5db" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
