            ...
            <div className="text-center my-8">
                ...
                <div className="flex justify-center items-center mt-8 gap-4">
                    <div className="border-2 flex items-center shadow-md border-gray-200 hover:border-black p-4 ease-in duration-200">
                        ...
                        <h1 className='ml-2'>+62 xxxx xxxx xxxx</h1>
                    </div>

                    <div className="border-2 border-gray-200 flex shadow-md items-center hover:border-black p-4 ease-in duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="black" class="bi bi-envelope" viewBox="0 0 16 16">
                            <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z" />
                        </svg>
                        <h1 className='ml-2'>dinusmail@dinus.ac.id</h1>
                    </div>
                </div>
            </div>
            {/* <div className="grid grid-cols-2">
                <div className="cols-span-1 bg-white">
                    <div className="flex flex-col justify-center items-center p-8">
                        <h1 className='text-black text-2xl font-bold'>Hubungi kami</h1>
                    </div>
                </div>
                ...
                <div className="col-span-1 bg-blue-900">
                    <div className="flex justify-center items-center lg:pt-10 pt-24">
                        <div className="flex items-center">
                            ...
                            <h1 className='text-white font-bold ml-4 lg:text-xl text-md'>+62 xxx xxx</h1>
                        </div>
                        <div className=""></div>
                    </div>
                    <div className="flex justify-center items-center p-8">
                        <div className="flex items-center">
                            ...
                            <h1 className='text-white font-bold ml-4 lg:text-xl text-md'>example@gmail.com</h1>
                        </div>
                        <div className=""></div>
                    </div>
                </div>
